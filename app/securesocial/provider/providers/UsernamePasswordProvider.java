...
public class UsernamePasswordProvider extends IdentityProvider {
	...
	private boolean passwordMatches(String password, String userPassword) {
		return UserService.isPasswordMatch(password, userPassword);
	}
	 ...
	 * 
	 * @see
	 * securesocial.provider.IdentityProvider#fillProfile(securesocial.provider.SocialUser, java.util.Map)
	 */
	@Override
	protected void fillProfile(SocialUser user, Map<String, Object> authContext) {
		// there's nothing to do here, since the user is being loaded from the
		// DB it should already have all the required fields set.
	}
}
